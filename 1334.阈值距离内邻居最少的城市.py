...
统计每个城镇，其满足条件的城镇有多少个
我们找出最少的即可
Floyd-Warshall 算法的时间复杂度和空间复杂度都是, 而空间复杂度可以优化到。Floyd-Warshall 的基本思想是对于每两个点之间的最小距离，要么经过中间节点 k，要么不经过，我们取两者的最小值，这是一种动态规划思想，详细的解法可以参考Floyd-Warshall 算法(wikipedia)
代码
代码支持：Python3
Python3 Code:
class Solution:
